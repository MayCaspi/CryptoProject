# -*- coding: utf-8 -*-
"""
Created on Wed Dec 28 21:20:55 2022

@author: user
"""
def encrypt(plaintext, key):
    camellia = Camellia(key)
    c_msg = camellia.ECB_Encrypt(plaintext)
    return c_msg

def decrypt(ciphertext, key):
    camellia = Camellia(key,dec=True)
    msg = camellia.ECB_Decrypt(ciphertext)
    return msg.rstrip()
...
class Camellia:
    ...
    def ECB_Encrypt(self, data):
        """Encrypts the given data using the ECB mode of operation"""
